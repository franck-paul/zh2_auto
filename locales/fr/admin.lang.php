...
L10n::$locales['<p>The blog description is used as second part of the title, after the blog\'s name, with a link to a static page (URL: about).<br>
You can modify this link by editing the <code>_top.html</code> template file (see <a href="blog_theme.php">Blog apparence</a> > <a href="plugin.php?p=themeEditor">Theme editor</a>).</p>'] = '<p>La description du blog est utilisée comme deuxième partie du titre, après le nom du blog, avec un lien vers une page statique (URL: about).<br>
Vous pouvez modifier ce lien en éditant le fichier <em>template</em> <code>_top.html</code> (voir <a href="blog_theme.php">Apparence du blog</a> > <a href="plugin.php?p=themeEditor">Modifier les fichiers du thème</a>).</p>';
...
L10n::$locales['This theme cope with comments and trackbacks, if they are allowed (see <a href="blog_pref.php">blog parameters</a>).'] = 'Ce thème tient compte des commentaires et des rétroliens, s\'ils sont autorisés (voir les <a href="blog_pref.php">paramètres du blog</a>).';
